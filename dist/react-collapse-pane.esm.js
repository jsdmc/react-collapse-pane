...
var verticalCss = /*#__PURE__*/css(_templateObject || (_templateObject = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  width: 0;\n  height: 100%;\n"])));
var horizontalCss = /*#__PURE__*/css(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  width: 100%;\n  height: 0;\n"])));
var coverCss = /*#__PURE__*/css(_templateObject3 || (_templateObject3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n"])));
var PaneRoot = /*#__PURE__*/styled.div(_templateObject4 || (_templateObject4 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: relative;\n  outline: none;\n  border: 0;\n  overflow: hidden;\n  display: flex;\n  flex-grow: 1;\n  flex-shrink: 1;\n  ", "\n  ", "\n"])), function (props) {
...
var WidthPreserver = /*#__PURE__*/styled.div(_templateObject5 || (_templateObject5 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  ", "\n  ", "\n"])), coverCss, function (props) {
  return props.$isCollapsed && css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteralLoose(["\n      * {\n        z-index: 0;\n      }\n      z-index: 0;\n    "])));
});
var CollapseOverlay = /*#__PURE__*/styled.div(_templateObject7 || (_templateObject7 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  ", "\n  ", ";\n  opacity: ", ";\n  transition: opacity ", "ms ease-in-out;\n"])), function (props) {
  return props.$isCollapsed && coverCss;
}, function (props) {
  return props.$isCollapsed && css(_templateObject8 || (_templateObject8 = _taggedTemplateLiteralLoose(["\n      z-index: 1;\n    "])));
}, function (props) {
...
var UnMemoizedPane = function UnMemoizedPane(_ref) {
  ...
  }, createElement(CollapseOverlay, {
    "$isCollapsed": isCollapsed,
    "$timeout": timeout,
    style: collapseOverlayCss
  }), createElement(WidthPreserver, {
    "$isCollapsed": isCollapsed,
...
var Pane = /*#__PURE__*/memo(UnMemoizedPane);

var _templateObject$1, _templateObject2$1, _templateObject3$1, _templateObject4$1, _templateObject5$1, _templateObject6$1;
var topBottomCss = /*#__PURE__*/css(_templateObject$1 || (_templateObject$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  top: 0;\n  bottom: 0;\n"])));
var leftRightCss = /*#__PURE__*/css(_templateObject2$1 || (_templateObject2$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  right: 0;\n  left: 0;\n"])));
var ButtonWrapper = /*#__PURE__*/styled.div(_templateObject3$1 || (_templateObject3$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  cursor: pointer;\n  position: absolute;\n"])));
var ButtonContainer = /*#__PURE__*/styled.div(_templateObject4$1 || (_templateObject4$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  z-index: 3;\n  position: absolute;\n  overflow: initial;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n\n  ", ";\n  ", "\n"])), function (props) {
  return (props.$isVertical ? 'width' : 'height') + ": " + props.$grabberSize;
}, function (props) {
  return props.$isVertical ? topBottomCss : leftRightCss;
});
var ResizeGrabber = /*#__PURE__*/styled.div(_templateObject5$1 || (_templateObject5$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  position: absolute;\n  z-index: 3;\n  transform: ", ";\n  cursor: ", ";\n  ", "\n"])), function (props) {
...
var ResizePresentation = /*#__PURE__*/styled.div(_templateObject6$1 || (_templateObject6$1 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  z-index: 2;\n  position: absolute;\n  ", "\n"])), function (props) {
  return props.$isVertical ? topBottomCss : leftRightCss;
});
...
var verticalCss$1 = /*#__PURE__*/css(_templateObject$2 || (_templateObject$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  left: 0;\n  right: 0;\n  flex-direction: row;\n"])));
var horizontalCss$1 = /*#__PURE__*/css(_templateObject2$2 || (_templateObject2$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  bottom: 0;\n  top: 0;\n  flex-direction: column;\n  min-height: 100%;\n  width: 100%;\n"])));
var Wrapper = /*#__PURE__*/styled.div(_templateObject3$2 || (_templateObject3$2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  display: flex;\n  flex: 1;\n  height: 100%;\n  position: absolute;\n  outline: none;\n  overflow: hidden;\n  ", "\n"])), function (props) {
...
var Resizer = function Resizer(_ref) {
  ...
  var grabberSizeWithUnit = useMemo(function () {
  ...
  var handleButtonMousedown = useCallback(function (event) {
    event.stopPropagation();
  }, []);
  var debouncedSetHovered = useCallback(debounce(function () {
    return setIsHovered(true);
  }, 50), [setIsHovered]);
  var handleMouseEnterGrabber = useCallback(function () {
    debouncedSetHovered();
  }, [debouncedSetHovered]);
  var debouncedSetNotHovered = useCallback(debounce(function () {
    return setIsHovered(false);
  }, 100), [setIsHovered]);
  var handleMouseLeaveGrabber = useCallback(function () {
    return debouncedSetNotHovered();
  }, [debouncedSetNotHovered]);
  var getWidthOrHeight = useCallback(function (size) {
    return isVertical ? {
      width: size
    } : {
      height: size
  ...
  var preButtonFlex = useMemo(function () {
    var _collapseOptions$butt;
  ...
  var postButtonFlex = useMemo(function () {
  ...
  }, collapseButton), React__default.createElement(Fade, {
...
var useDragStateHandlers = function useDragStateHandlers(isVertical, onDragFinished) {
  ...
  var beginDrag = useCallback(function (_ref) {
...
var useGetMovedSizes = function useGetMovedSizes(_ref) {
  ...
  return useCallback(function (dragState) {
...
var useUpdateCollapsedSizes = function useUpdateCollapsedSizes(_ref) {
  ...
  return useCallback(function (indices) {
...
var useRecalculateSizes = function useRecalculateSizes(_ref) {
  var getCurrentPaneSizes = _ref.getCurrentPaneSizes,
      ...
      setMovedSizes = _ref.setMovedSizes,
      setSizes = _ref.setSizes;
  return useCallback(function (initialSizes) {
...
var useSplitPaneResize = function useSplitPaneResize(options) {
  ...
  var initialSizes = useMemo(function () {
  ...
  var _useState = useState(initialSizes),
      sizes = _useState[0],
      setSizes = _useState[1];

  var _useState2 = useState(sizes),
      movedSizes = _useState2[0],
      setMovedSizes = _useState2[1];

  var _useState3 = useState(originalCollapsedSizes != null ? originalCollapsedSizes : new Array(children.length).fill(null)),
  ...
  var resetSizes = useCallback(debounce(function () {
  ...
  [initialSizes]); //populates the sizes of all the initially populated childPanes, adjust sizes based on collapsed state

  var childPanesWithSizes = useMemo(function () {
...
var useGetIsPaneCollapsed = function useGetIsPaneCollapsed(_ref) {
  var collapsedIndices = _ref.collapsedIndices;
  return useCallback(function (paneIndex) {
...
var Button = /*#__PURE__*/styled.div(_templateObject$3 || (_templateObject$3 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n  width: 1.8rem;\n  height: 1.8rem;\n  border-radius: 300px;\n  background: #0092d1;\n  cursor: pointer;\n  user-select: none;\n  text-align: center;\n  color: white;\n  border: 2px rgba(200, 200, 200, 0.5) solid;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  svg {\n    width: 100%;\n    height: 100%;\n  }\n"])));
var Direction;
...
export { SplitPane };
//# sourceMappingURL=react-collapse-pane.esm.js.map
